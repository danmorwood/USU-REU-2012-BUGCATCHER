    ...
    while($loop == 0)
    {
      ...
      if(!$getIDExist)
      {
        ...
        //if (fopen("CompTest.txt","x+"))
        {
					...
					fwrite($compFile,"\r\n");
					//Temp: Used to implement the new predef hints code
					fwrite($compFile,"Problem1");
					fwrite($compFile,"\r\n");
					fwrite($compFile,"Problem2");
					fwrite($compFile,"\r\n");
					fwrite($compFile,"Problem3");
					fwrite($compFile,"\r\n");
					fwrite($compFile,"Problem4");
					fwrite($compFile,"\r\n");
					fwrite($compFile,"Problem5");
					fwrite($compFile,"\r\n");
